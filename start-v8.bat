...
rem          + the ONE shared MCP server (:9402) every shell talks to. Each start-*.ps1 is idempotent (never stacks a second instance).
setlocal
set "ROOT=%~dp0"
...
echo.
echo v8 up: broker http://127.0.0.1:9300/v1/health   board http://127.0.0.1:9400/ui   pool http://127.0.0.1:9301/v1/doctor   mcp http://127.0.0.1:9402/healthz
