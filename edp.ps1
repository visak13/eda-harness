...
$SVC = [ordered]@{
  ...
  # code-server: a node.exe pair running from the pinned install on a named pipe, behind the host guard
  # (s-03c7e9168b: edp8.code_guard, the venv python pair, holds the port; its --tag names the install).
