// Vendored from microsoft/vscode tag 1.138.0 (= code-server 4.138, S2 lock), extensions/git/src/api/git.d.ts.
// Types only: import with `import type`, nothing is required at runtime (strategyll-ab18531441 §2).
/*---------------------------------------------------------------------------------------------
