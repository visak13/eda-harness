# edp8 board — three visual directions
...
|---|---|---|---|
| `--rail` | `#F7F8FA` | `#FAF9F6` | `#F5F6F7` |
| `--app` | `#FFFFFF` | `#FFFFFF` | `#FFFFFF` |
| `--panel` | `#F7F8FA` | `#FAF9F6` | `#F5F6F7` |
| `--raised` | `#FFFFFF` | `#FFFFFF` | `#FFFFFF` |
| `--hover` | `#F0F2F5` | `#F1EEE7` | `#EAEDF0` |
| `--border` | `#DDE1E6` | `#DCD7CE` | `#DCE0E4` |
| `--text` | `#20242B` | `#292923` | `#252B31` |
| `--secondary` | `#525C69` | `#5B5A50` | `#53606B` |
| `--muted` | `#657080` | `#706D63` | `#63717D` |
| `--brand` | `#B94712` | `#A74317` | `#B84016` |
| `--cyan` | `#B94712` | `#A74317` | `#B84016` |
| `--success` | `#247348` | `#3D6B4C` | `#236D53` |
| `--warning` | `#775B19` | `#7A5C22` | `#775B19` |
| `--danger` | `#AD3348` | `#A13D3D` | `#AA3650` |
| `--link` | `#285B86` | `#3D625B` | `#306182` |
| `--focus` | `#B94712` | `#A74317` | `#B84016` |
...
|---|---|---|---|
| `--brand-hover` | `#9E380B` | `#8C3511` | `#9B3210` |
| `--brand-active` | `#82300D` | `#712B10` | `#7C2A10` |
| `--selected-bg` | `#FFF0E7` | `#FBEEE5` | `#FFF0E9` |
| `--control-border` | `#858E9B` | `#928B7D` | `#838F99` |
| `--radius-control` | `6px` | `2px` | `14px` |
| `--radius-card` | `6px` | `2px` | `14px` |
| `--done-fg` | `#247348` | `#3D6B4C` | `#236D53` |
| `--done-bg` | `#EAF5EE` | `#EFF4EC` | `#E6F4EE` |
| `--blocked-fg` | `#AD3348` | `#A13D3D` | `#AA3650` |
| `--blocked-bg` | `#FCEEF0` | `#F9EEEE` | `#FCEBF0` |
| `--progress-fg` | `#286581` | `#3C6278` | `#2B638D` |
| `--progress-bg` | `#EAF3F8` | `#EDF2F5` | `#E8F2FB` |
| `--review-fg` | `#775B19` | `#7A5C22` | `#745A88` |
| `--review-bg` | `#FAF3DD` | `#F8F2E5` | `#F3EDF8` |
...
| Contrast pair | A | B | C |
|---|---|---|---|
| Orange / white | 5.29:1 | 6.07:1 | 5.55:1 |
| White / hover | 6.94:1 | 7.98:1 | 7.35:1 |
| White / pressed | 8.83:1 | 10.22:1 | 9.56:1 |
| Muted / white | 5.02:1 | 5.18:1 | 5.01:1 |
| Input border / white | 3.31:1 | 3.38:1 | 3.30:1 |
| Done label / fill | 5.19:1 | 5.53:1 | 5.48:1 |
| Blocked label / fill | 5.57:1 | 5.69:1 | 5.45:1 |
| In-progress label / fill | 5.71:1 | 5.80:1 | 5.66:1 |
| Review label / fill | 5.75:1 | 5.57:1 | 5.13:1 |
