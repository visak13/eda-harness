...
- knowledge.py _always_include selects binding and must-follow decisions regardless of the question. As of 736d248 (architect ruling F6, 2026-09-23) binding text is never cut: the always section takes what binding needs, the ranked section absorbs the rest, and the receipt reports always_bytes. kg-lookup.png step 2, the budget bar, the receipt and the footer were re-rendered to say so (the old 2,000-byte trim was pre-736d248).
