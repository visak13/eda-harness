...
**PROTOCOL — you spawn architect/engineer/adversary; the BOARD pairs reviewer and qa:**
...
3. Story in_review → the BOARD spawns `reviewer.<story>` (review_required only). Never by hand.
