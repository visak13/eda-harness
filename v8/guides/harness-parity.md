...
## 5. Measured rules [M] — session 7edf0320, 2026-09-14
...
| missed periods while busy | not documented | between 14:40:29Z and the compaction at 15:22Z no 15:10 fire is recorded (seat busy); after 15:22 the next fire had not landed by 15:30Z → at most one deferred fire is queued (no catch-up burst) [partial — re-measure with job eeaf7ce0] | JSONL 14:40–15:30Z |
| one-shot early fire on :00 | "up to 90 s early" | job a40ab141 `0 21 14 9 *` and 3e070b19 `3 21 14 9 *` armed 15:26Z; result rows appended below when they fire | pending |
...
| CronList after one-shot fire | auto-delete | pending (row appended after a40ab141 fires) | |
